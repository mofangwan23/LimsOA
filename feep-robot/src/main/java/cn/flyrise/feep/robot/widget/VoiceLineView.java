...
public class VoiceLineView extends View implements Runnable {
	...
	private void initAtts(Context context, AttributeSet attrs) {
		...
		voiceLineColor = typedArray.getColor(R.styleable.voiceView_voiceLine, Color.parseColor("#50ccfe"));
		maxVolume = typedArray.getFloat(R.styleable.voiceView_maxVolume, 30);
		...
		if (mode == RECT) {
			...
			middleLineColor = typedArray.getColor(R.styleable.voiceView_middleLine, Color.parseColor("#50ccfe"));
			middleLineHeight = typedArray.getDimension(R.styleable.voiceView_middleLineHeight, 2);
