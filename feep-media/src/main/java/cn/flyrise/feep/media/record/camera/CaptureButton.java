...
import static cn.flyrise.feep.media.record.camera.JCameraView.BUTTON_STATE_BOTH;
import static cn.flyrise.feep.media.record.camera.JCameraView.BUTTON_STATE_ONLY_CAPTURE;
import static cn.flyrise.feep.media.record.camera.JCameraView.BUTTON_STATE_ONLY_RECORDER;
...
public class CaptureButton extends View {
	...
	public CaptureButton(Context context, int size) {
		...
		button_state = BUTTON_STATE_ONLY_RECORDER;  //录制
	...
	private void startCaptureAnimation(float inside_start) {
		...
		inside_anim.addListener(new AnimatorListenerAdapter() {
			@Override
			public void onAnimationEnd(Animator animation) {//回调拍照接口
	...
	private class LongPressRunnable implements Runnable {
		...
		public void run() {
			...
			//启动按钮动画，外圆变大，内圆缩小
			startRecordAnimation(
					button_outside_radius, button_outside_radius + outside_add_size,
