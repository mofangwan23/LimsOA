...
public class CameraParamUtil {
    ...
    public Camera.Size getPreviewSize(List<Size> list, int th, float rate) {
    ...
    public Camera.Size getPictureSize(List<Size> list, int th, float rate) {
        Collections.sort(list, sizeComparator);
        int i = 0;
        for (Camera.Size s : list) {
            if ((s.width > th) && equalRate(s, rate)) {
    ...
    private Camera.Size getBestSize(List<Size> list, float rate) {
