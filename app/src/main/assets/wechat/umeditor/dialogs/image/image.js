(function () {
    ...
    var utils = UM.utils,
        ...
        getAllPic: function (sel, $w, editor) {
            ...
            $.each($imgs, function (index, node) {
                ...
                var wth = node.width;
                if (node.width > $(window).width()) {
                    me.scale(node, $(window).width() -
    ...
    UM.registerWidget('image', {
        tpl: "<link rel=\"stylesheet\" type=\"text/css\" href=\"<%=image_url%>image.css\">" +
            ...
            "<div class=\"edui-image-dragTip\"></div>" +
            "</div>" +
            "<div class=\"edui-image-JimgSearch edui-tab-pane\">" +
            "<div class=\"edui-image-searchBar\">" +
            "<table><tr><td><input class=\"edui-image-searchTxt\" type=\"text\"></td>" +
            "<td><div class=\"edui-image-searchAdd\"><%=lang_btn_add%></div></td></tr><tr><td colspan='2' style='color:#df0000;'>注：必须是以.gif|.jpg|.jpeg|.png为结尾的网址</td></tr></table>" +
            "</div>" +
