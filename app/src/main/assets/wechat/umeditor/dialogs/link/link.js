(function(){
    ...
    UM.registerWidget('link', {
        tpl: "<style type=\"text/css\">" +
            ...
            ".edui-dialog-link .edui-link-txt{width:90%;height:21px;line-height:21px;border:1px solid #d7d7d7;}" +
            "</style>" +
            "<table class=\"edui-link-table\" style='width: 95%;'>" +
            "<tr>" +
            ...
            "<tr>" +
            "<td colspan=\"2\">" +
            "<label for=\"target\" style=\"float:left;width:150px;\"><%=lang_input_target%></label>" +
            "<input id=\"edui-link-Jtarget\" type=\"checkbox\" style=\"float:left;margin-top:10px;\"/>" +
            "</td>" +
            "</tr>" +
//            "<tr>" +
