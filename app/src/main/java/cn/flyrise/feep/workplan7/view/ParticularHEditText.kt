 ...
 * 字符数提示在横
 */
class ParticularHEditText : RelativeLayout {

    private var numTitleMax = 12

    constructor(context: Context) : this(context, null)

    constructor(context: Context, attrs: AttributeSet?) : super(context, attrs) {
        LayoutInflater.from(context).inflate(R.layout.particular_edit_text_h_layout, this)
    ...
    fun setText(text: String?) {
        ...
        this.etContent.setSelection(text?.length ?: 0)
    }
}