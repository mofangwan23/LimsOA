...
public interface WheelViewAdapter {
	...
	/**
	 * Get a IView that displays the record at the specified position in the record
	 * set
	 * 
	 * @param index
	 *            the item index
	 ...
	 * @return the wheel item IView
	 */
	View getItem(int index, View convertView, ViewGroup parent);

	/**
	 * Get a IView that displays an empty wheel item placed before the first or
