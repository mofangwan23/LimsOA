...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    public void addView(View child, int index, ViewGroup.LayoutParams params) {
        ...
        if (refreshableView instanceof ViewGroup) {
            ...
            throw new UnsupportedOperationException("Refreshable IView is not a ViewGroup so can't addView");
        }
    }
     ...
     * pass-through to the Refreshable IView
     */
    ...
    /**
     * This is implemented by derived classes to return the created IView. If you
     * need to use a custom IView (such as a custom ListView), override this
     ...
     *                created IView
     * @return New instance of the Refreshable IView
     */
    ...
    /**
     * Implemented by derived class to return whether the IView is in a state
     * where the user can Pull to Refresh by scrolling from the end.
     * @return true if the IView is currently in the correct state (for example,
     ...
     * @return true if the IView is currently the correct state (for example, top
     * of a ListView)
     */
    ...
    protected final void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        // Update the Refreshable IView layout
    ...
    protected final void refreshRefreshableViewSize(int width, int height) {
        // We need to set the Height of the Refreshable IView to the same as
        // this layout
    ...
    protected final void setHeaderScroll(final int value) {
        ...
        /**
         * Use a Hardware Layer on the Refreshable IView if we've scrolled at
    ...
    /**
     * Updates the IView State when the mode has been set. This does not do any
    ...
    protected void updateUIForMode() {
        ...
        // Remove Header, and then add Header Loading IView again if needed
        ...
        // Remove Footer, and then add Footer Loading IView again if needed
    ...
    /**
     * Actions a Pull EventIgnoreVersion
     * @return true if the EventIgnoreVersion has been handled, false if there has been no
     * change
     */
    ...
    public enum Mode {
        ...
        /**
         * Only allow the user to Pull from the start of the Refreshable IView to
        ...
        /**
         * Only allow the user to Pull from the end of the Refreshable IView to
    ...
    public interface OnPullEventListener<V extends View> {
         ...
         * pulling.
         * @param refreshView - IView which has had it's state change.
         * @param state       - The new state of IView.
