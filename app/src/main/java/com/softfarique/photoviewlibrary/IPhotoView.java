...
public interface IPhotoView {
     ...
     * Rectangle is relative to this IView and includes all scaling and
     * translations.
     *
     ...
     * IView. An example would be the user panning or scaling the Photo.
     *
     * @param listener - Listener to be registered.
     */
    ...
    /**
     * Register a callback to be invoked when the Photo displayed by this IView
    ...
    /**
     * Register a callback to be invoked when the IView is tapped with a single
     * tap.
     *
     * @param listener - Listener to be registered.
     */
