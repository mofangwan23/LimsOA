...
public class CropImageView extends TransformImageView {
	...
	public Bitmap cropImage() {
		...
		if (width + left > viewBitmap.getWidth()) {
			int differenceW = (width + left) - viewBitmap.getWidth();
			cropWidth = width - differenceW;
		}
		if (height + top > viewBitmap.getHeight()) {
			int differenceH = (height + top) - viewBitmap.getHeight();
			cropHeight = height - differenceH;
		}
