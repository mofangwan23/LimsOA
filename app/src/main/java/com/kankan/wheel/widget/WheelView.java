...
public class WheelView extends View {
    ...
    private void initData(Context context) {
        ITEM_OFFSET_PERCENT = context.getResources().getDimensionPixelOffset(R.dimen.mdp_10);
    ...
    private void initResourcesIfNecessary() {
        if (centerDrawable == null) {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.wheelview_val);
        }
