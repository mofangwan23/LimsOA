...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ImageView headIcon = (ImageView) findViewById(R.id.swing_card);
		...
		EaseUserUtils.setUserAvatar(VoiceCallActivity.this, username, headIcon);
		...
		if (!isInComingCall) {// outgoing call
			...
			sendCmdCallMessage(EmChatContent.CMD_ACTION_PC_VOICE_CALL, username);
		}
		else { // incoming call
...
//                                startMonitor();
	...
	public void onClick(View v) {
		if (v.getId() == R.id.btn_refuse_call) {
			...
			closeSpeakerOn();
			callStateTextView.setText(getResources().getString(R.string.chatting));
			comingBtnContainer.setVisibility(View.INVISIBLE);
			hangupBtn.setVisibility(View.VISIBLE);
	...
	protected void onResume() {
		super.onResume();
		tvPermission.setVisibility(FePermissions.checkSelfPermission(this, permission.RECORD_AUDIO) ? View.GONE : View.VISIBLE);
	}
	...
	private void setAudioPermissions() {
		FePermissions.with(VoiceCallActivity.this)
