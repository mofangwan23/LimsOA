...
public abstract class EaseChatPrimaryMenuBase extends RelativeLayout {
	...
	public abstract View getEmotionButton();
	...
	public abstract void setReplyMessage(String replyMessage);

	public abstract String getReplyMessage();

	public abstract TextView getReplyTextView();

	public abstract void hideReplyTextView();
